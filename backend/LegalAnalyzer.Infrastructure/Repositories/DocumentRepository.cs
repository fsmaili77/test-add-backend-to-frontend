    ...
    public class DocumentRepository : IDocumentRepository
    {
        ...
        public async Task<IEnumerable<Document>> GetAllAsync()
        {
            return await _context.Documents
                .AsSplitQuery() // Enable query splitting to avoid performance issues
                .Include(d => d.Tags)
                ...
                .ThenInclude(ra => ra!.Factors) // Null-forgiving operator for RiskAssessment.Factors
                .ToListAsync();
        }
        ...
        {
            return await _context.Documents
                .AsSplitQuery() // Enable query splitting
                .Include(d => d.Tags)
                .Include(d => d.Keywords)
                .Include(d => d.ExtractedInfo)
                .ThenInclude(ei => ei.Parties)
        ...
        public async Task<Document> AddAsync(Document document)
        {
            ...
            // Ensure ExtractedInfo is initialized
            document.ExtractedInfo ??= new ExtractedInfo();
