// Legalanalyzer\src\pages\dashboard\index.jsx
...
//import { useLanguage } from '././contexts/LanguageContext';
import { getDocuments, deleteDocument, analyzeDocument } from '../../api';
...
const Dashboard = () => {
        ...
        const fetchDocs = async () => {
            ...
            try {
                ...
                const mappedDocs = docs.map(doc => ({
                    ...
                    hasAdvancedAnalysis: doc.status === 'Analyzed' && doc.summary,
    ...
    const filterTabs = [
        ...
        { key: 'Analyzed', label: texts.complete, count: documents.filter(d => d.status === "Analyzed").length },
        { key: 'Error', label: texts.failed, count: documents.filter(d => d.status === "Error").length }
    ];
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                            <div className="flex items-center justify-end space-x-2">
                                                                ...
                                                                <button
                                                                    ...
                                                                    title={document.hasAdvancedAnalysis ? texts.viewAnalyzedDocument : texts.analyzeDocument}
                                                                >
