// legalanalyzer/src/pages/dashboard/components/RecentActivity.jsx - Updated with real data
    ...
    documents.forEach(doc => {
      ...
      if (doc.uploadedAt) {
        activities.push({
          ...
          type: 'upload',
          title: doc.filename,
          description: `Document uploaded (${doc.size ? formatFileSize(doc.size) : 'Unknown size'})`,
      ...
      if (doc.status === 'Analyzed' && doc.analysis_duration_ms) {
        const analysisTime = new Date(doc.uploadedAt);
        ...
        activities.push({
          ...
          type: 'analysis',
          title: doc.filename,
          description: `Gemini AI analysis completed in ${(doc.analysis_duration_ms / 1000).toFixed(1)}s${doc.parties ? ` - Parties identified: ${doc.parties.split(',').length}` : ''}`,
        ...
        return (
          <button
            onClick={() => {
              ...
              console.log('Retry analysis for document:', activity.documentId);
            }}
        ...
        {displayedActivities.map((activity) => (
          <div key={activity.id} className="flex items-start space-x-3 group">
            ...
            <div className="flex-1 min-w-0">
              ...
              {/* Status indicator for processing activities */}
